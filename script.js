// NOTE: the background rotation used to live here. It moved into a small
// inline <script> in each page's <head> — this file loads at the end of
// <body>, so the browser could not even begin fetching the background image
// until the whole document had been parsed. Choosing it in <head> starts the
// download immediately. See the "background rotation" block in index.html,
// author.html and resources.html.
